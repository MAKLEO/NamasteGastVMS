...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "id10033272_namaste_gast";
    ...
    private static final String KEY_BADGE_NUMBER = "id_number";
    ...
    private static final String KEY_LICENSE_PLATE = "vehicle_no";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        User adminUser = new User("admin1", "makchamp1@gmail.com", "strive123", USER_ADMIN);
        User guestUser = new User("visitor2", "asha.khullar@gmail.com", "strive123", USER_GUEST);
