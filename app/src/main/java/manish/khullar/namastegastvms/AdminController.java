...
import static manish.khullar.namastegastvms.Config.DISPLAY_EMPLOYEES;
import static manish.khullar.namastegastvms.Config.DISPLAY_SUPPLIERS;
import static manish.khullar.namastegastvms.Config.DISPLAY_VISITORS;
...
public class AdminController extends AppCompatActivity implements View.OnClickListener {
    ...
    public void sendEmail() {
        if (isConnectedToDatabase()) {
            Intent sendEmail = new Intent(this,   manish.khullar.namastegastvms.SendEmailWithAttachment.class);
    ...
    public void viewAllUsers(View view) {
        Intent viewUsers = new Intent(this,   manish.khullar.namastegastvms.UsersListActivity.class);
        startActivity(viewUsers);
    }

    public void addAccount(View view) {
        Intent intentRegister = new Intent(getApplicationContext(), manish.khullar.namastegastvms.RegisterActivity.class);
        startActivity(intentRegister);
    }

    public void deleteUser(View view) {
        Intent deleteUser = new Intent(getApplicationContext(), manish.khullar.namastegastvms.DeleteUser.class);
    ...
    public void deleteVisitor(View view) {
        if (isConnectedToDatabase()) {
            Intent deleteVisitor = new Intent(getApplicationContext(), manish.khullar.namastegastvms.DeleteVisitor.class);
