...
public class DatePicker extends Activity {
    ...
    public void displayRange(View view) {
        ...
        switch (guestType) {
            case VISITOR:
                Intent visitor = new Intent(this, manish.khullar.namastegastvms.DisplayVisitors.class);
                ...
                break;
            case EMPLOYEE:
                Intent employee = new Intent(this, manish.khullar.namastegastvms.DisplayEmployees.class);
                ...
                break;
            case SUPPLIER:
                Intent supplier = new Intent(this, manish.khullar.namastegastvms.DisplaySupplier.class);
    ...
    public void displayTodayResult(View view) {
        switch (guestType) {
            case VISITOR:
                Intent visitor = new Intent(getApplicationContext(), manish.khullar.namastegastvms.DisplayVisitors.class);
    ...
    public void displayLastMonthResult(View view) {
        switch (guestType) {
            case VISITOR:
                ...
                break;
            case EMPLOYEE:
                Intent employee = new Intent(getApplicationContext(), manish.khullar.namastegastvms.DisplayEmployees.class);
    ...
    public void displayLsatThreeMonthsResult(View view) {
        switch (guestType) {
            ...
            case EMPLOYEE:
                ...
                break;
            case SUPPLIER:
                Intent supplier = new Intent(getApplicationContext(), manish.khullar.namastegastvms.DisplaySupplier.class);
