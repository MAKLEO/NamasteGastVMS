...
public class EmployeeController extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String gdprMessage = "The General Data Protection Regulation (GDPR) is a regulation in EU law on data protection and privacy for all individuals within the European Union and the European Economic Area. Visitors to NamasteGast HQ must answer the questions below, so it is known who is visiting the premises and for what reasons. This way it is possible to keep the building secure. And to guarantee the safety of the persons inside. We will not share your personal data for marketing purposes. Today, the Facility Desk and other visitors may have access to personal information. This visitor form will be stored at the end of today and destroyed after three (3) months. Please note that you are under no obligation to provide the information requested. However, if you decline,NamasteGast had the right to refuse you access to the premises.";
